...
class Post(models.Model):
    ...
    title = models.CharField(verbose_name='タイトル',max_length=10,blank=False,null=False)
    content = models.CharField(verbose_name='本文',max_length=44,blank=False,null=False)
